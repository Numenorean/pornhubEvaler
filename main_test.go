...
var (
	...
	rnKeyDataOld = "RNKEY=1022291*1947641:389958454:2040500497:1"
	rnKeyDataNew = "RNKEY=1614233*1889527:359467023:489684649:1"
)
...
func TestEvalWithOldData(t *testing.T) {
	v := Eval(dataOld)
	if v != rnKeyDataOld {
		t.Errorf("Expected %s, got %s", rnKeyDataOld, v)
	}
}

func TestEvalWithNewData(t *testing.T) {
	v := Eval(dataNew)
	if v != rnKeyDataNew {
		t.Errorf("Expected %s, got %s", rnKeyDataNew, v)
	}
}
